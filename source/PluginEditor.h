...
private:
    ...
    LabeledKnob reeseDetune, reeseWidth, hornBend, screechDrive;
    LabeledKnob oscAWave, oscBWave, oscCWarp, subLevel;
    LabeledKnob cutoff, res, filter2Cutoff, distDrive;
    LabeledKnob lfoRate, lfoAmt, envAmt, harmMix;
    LabeledKnob glide, masterGain, subOctave, hornFormant;
